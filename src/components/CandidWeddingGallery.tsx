...
// Import all new candid wedding images
...
const CandidWeddingGallery = () => {
  return (
    <div className="container mx-auto px-6 py-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {candidWeddingImages.map((image, index) => (
          <div
            key={index}
...
export default CandidWeddingGallery;